...
- [`cli/plan.md`](cli/plan.md) — Plan command, two-phase planning pipeline, raw-mode interactive requirements gathering (TTY) and buffered input (pipes), autonomous document generation, --from flag, session resolution, plan resumption, provider integration
...
Build, deployment, and CI/CD infrastructure.
